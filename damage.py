...
class damageAllocation(Dialog):
    ...
    def apply(self):
        ...
        self.ship['WG']['cur']=self.ship['WG']['cur'] - int(self.pwrSpn.get())
        self.ship['B']['cur']=self.ship['B']['cur'] - int(self.pwrSpn.get())
        self.ship['S']['cur']=self.ship['S']['cur'] - int(self.pwrSpn.get())
        self.ship['E']['cur']=self.ship['E']['cur'] - int(self.pwrSpn.get())
        self.ship['T']['cur']=self.ship['T']['cur'] - int(self.pwrSpn.get())
        self.ship['A']['cur']=self.ship['A']['cur'] - int(self.pwrSpn.get())
        self.ship['SR']['cur']=self.ship['SR']['cur'] - int(self.pwrSpn.get())
        self.ship['H']['cur']=self.ship['H']['cur'] - int(self.pwrSpn.get())
        print (self.ship)
